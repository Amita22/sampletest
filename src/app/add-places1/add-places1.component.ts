...
onSavePlace(){
  ...
  this.addplaces1service.addplace(this.form.value.placeType, this.form.value.title, this.form.value.Description, this.form.value.image, this.form.value.amount, this.weather, this.form.value.latitude, this.form.value.longitude, this.form.value.city);
